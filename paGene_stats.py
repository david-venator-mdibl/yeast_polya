...
WT_a  = np.hstack((array[4],array[5],array[6],array[14]))  #combines sample arrays to one array for each genetic type

ipa1_1_a = np.hstack((array[7],array[8],array[15]))

pcf11_2_a = np.hstack((array[9],array[10],array[16],array[17]))

cft2_1_a = np.hstack((array[18],array[19],array[11],array[12],array[13]))
